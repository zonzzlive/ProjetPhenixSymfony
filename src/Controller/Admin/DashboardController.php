...
class DashboardController extends AbstractDashboardController
{
    ...
    public function index(): Response
    {
        ...
        $url = $routeBuilder->setController(TeamMembreCrudController::class)->generateUrl();
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToRoute('Back to website', 'fas fa-home', 'app_homepage');
        yield MenuItem::linkToCrud('User', 'fas fa-list', User::class);
        yield MenuItem::linkToCrud('Team', 'fas fa-list', Team::class);
        yield MenuItem::linkToCrud('TeamMembre', 'fas fa-list', TeamMembre::class);
