 ...
 */
final class Version20220228133947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX team_id ON team_membre');
        $this->addSql('DROP INDEX team_id_2 ON team_membre');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX team_id ON team_membre (team_id)');
        $this->addSql('CREATE UNIQUE INDEX team_id_2 ON team_membre (team_id)');
